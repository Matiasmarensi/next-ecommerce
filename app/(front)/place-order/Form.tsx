...
const Form = () => {
  ...
  const { paymentMethod, shippingAddress, items, itemsPrice, taxPrice, shippingPrice, totalPrice, clear } =
    useCartService();
          ...
          <div className="card bg-base-300">
            <div className="card-body">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <button onClick={() => placeOrder()} disabled={isPlacing} className="btn btn-primary w-full">
